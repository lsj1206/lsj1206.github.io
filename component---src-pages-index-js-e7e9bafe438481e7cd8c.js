...
`;var P=e=>{let{totalPageSize:t,nowPage:r,onPageChange:n}=e;(0,l.useEffect)((()=>{r>t&&n(t||1)}),[t,r,n]);const a=(()=>{const e=[],n=Math.max(1,r-Math.floor(2.5)),l=Math.min(t,n+5-1);for(let t=Math.max(1,l-5+1);t<=l;t++)e.push(t);return e})();return l.createElement(z,null,l.createElement(A,{size:[20,20],icon:o.zP,onClick:()=>n(1)}),l.createElement(A,{size:[20,20],icon:o.$9,onClick:()=>n(Math.max(1,r-1))}),l.createElement(C,null,a.map((e=>l.createElement(D,{key:e,size:[30,30],text:e,$onPage:e===r,onClick:()=>n(e)})))),l.createElement(A,{size:[20,20],icon:o.Pt,onClick:()=>n(Math.min(t,r+1))}),l.createElement(A,{size:[20,20],icon:o.V0,onClick:()=>n(t)}))};const M=a.I4.div`
  display: flex;
  flex-direction: column;
...
`,s=()=>n.createElement("title",null,i.Ay.title);t.default=e=>{let{data:t}=e;t||(0,l.oo)("/404");const r=(0,o.A)(t);return n.createElement(m,null,n.createElement(c.A,{postlist:r,listName:"All Posts"}))}}}]);
//# sourceMappingURL=component---src-pages-index-js-e7e9bafe438481e7cd8c.js.map