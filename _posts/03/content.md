...
Windows에서 사용가능한 파일명 일괄 변경 프로그램인 **TagNamer**의 개발과정을 담은 포스트의
첫 페이지 입니다.
<br>
...
![TagNamer_01](./_assets/TagNamer_01.jpg)
...
![ListView + GridView 구조의 리스트](./_assets/list_beta.jpg)
...
<br>
이어지는 다음 포스트에서는 태그를 사용한 이름 변경 시스템 개발과 태그 개발에 대해 중점적으로 다룰 예정입니다.
